...
public class AddAppointmentActivity extends AppCompatActivity {
    ...
    private void setSpinnerItems() {
        ...
        ArrayAdapter<String> adapter1 = new ArrayAdapter<String>(this, R.layout.dropdown_item, timesArrayList);
        spinnerDays.setAdapter(adapter1);
        ArrayAdapter<String> adapter2 = new ArrayAdapter<String>(this, R.layout.dropdown_item, daysArrayList);
