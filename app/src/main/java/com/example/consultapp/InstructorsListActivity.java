...
import com.example.consultapp.adapters.InstructorsAdapter;
import com.example.consultapp.classes.GlobalVariables;
import com.example.consultapp.classes.Instructors;
import com.example.consultapp.classes.User;
            ...
            public boolean onMenuItemClick(MenuItem item) {
                switch (item.getItemId()) {
                    ...
                    case R.id.appointment:
                        startActivity(new Intent(InstructorsListActivity.this,AppointmentListActivity.class).putExtra("uid",uid));
                        return true;
                    default:
                        return true;
                }
